...
### v0.26.0 (2025年12月05日)
- 素材库第一版 (loonghfut)
- feat(shape-library): 添加拖拽功能并保存面板位置 (loonghfut)
- feat(shape-library): 添加素材库更新通知功能，支持面板自动刷新 (loonghfut)
- refactor: reorganize shape library components and update import paths (loonghfut)
- feat(shape-library): 添加搜索功能和懒加载，重置面板位置功能 (loonghfut)
- feat(shape-library): 添加触摸和滚动事件处理，防止面板滚动冒泡到画布 (loonghfut)
