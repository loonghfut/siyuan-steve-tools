...
# 重要！！！：由于思源数据库的数据结构发生变化，日程管理功能暂时不兼容思源3.3.0之后的版本，若更新到3.3.0之后的版本，请关闭日程管理功能。
...
- fix，wps脚本 (loonghfut)
- feat: 添加防抖机制以优化事件创建按钮的点击处理 (loonghfut)
- feat: 优化创建事件格式 (loonghfut)
- feat: 支持从自定义链接卡片转换为链接 (loonghfut)
- 优化看板，四象限的时间差显示 (loonghfut)
- chore: 更新版本号至0.13.2 (loonghfut)
- docs: 更新 v0.13.2 版本的更新日志 (loonghfut)
- feat: 添加 roaming 监控功能，获取WPS文档链接 (loonghfut)
- feat: 添加 F5 键事件触发功能 (loonghfut)
- feat: 添加 WPS 文件块导入功能，支持单条和批量导入 (loonghfut)
- feat: 更新 WPS 文件块导入功能，优化插入逻辑并增加 F5 刷新 (loonghfut)
- refactor: 重构事件打开数据面板逻辑 (loonghfut)
- refactor: 优化 Wps 模块初始化逻辑 (loonghfut)
- feat: 添加 WPS 文件图标 (loonghfut)
- 初步实现文件链接拉取 (loonghfut)
- feat: 优化 WPS 文件导入对话框，增加搜索和选择功能 (loonghfut)
- feat: 添加页面反色模式功能，允许用户反转页面整体颜色 (loonghfut)
- feat: 添加 WPS 文件块自定义模板功能，支持占位符并更新导入逻辑 (loonghfut)
- 取消滴答同步锁，优化短时间快速操作体验 (loonghfut)
