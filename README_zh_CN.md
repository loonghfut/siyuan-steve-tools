...
- feat: 删除 MindMapNodeShapeUtil 和 MindMapNodeTool 文件以简化代码结构 (loonghfut)
- feat: 添加思维导图功能，包括形状工具和节点管理 (loonghfut)
- fix: 注释掉 MindMapShapeUtil 中的 outline 属性以修复样式问题 (loonghfut)
- fix: 调整 MindMapShapeUtil 的最小宽高为 1，并禁用编辑模式 (loonghfut)
- feat: 添加双击创建单块功能的设置选项 (loonghfut)
- fix: 禁用思维导图形状的调整功能 (loonghfut)
- feat: 动态计算思维导图节点宽度并优化文本显示 (loonghfut)
- feat: 添加节点颜色更新功能及颜色选择器 (loonghfut)
- feat: add Mind Map components, hooks, and utilities (loonghfut)
- feat: 添加根节点锚点位置计算及更新逻辑，确保节点位置稳定 (loonghfut)
- feat: 添加思维导图主题选择功能，支持多种主题样式 (loonghfut)
- feat: 更新颜色选择器位置逻辑，支持动态调整以避免超出容器边界 (loonghfut)
- feat: 更新思维导图主题，简化主题样式并调整颜色选择逻辑 (loonghfut)
- feat: 更新主题样式，调整节点边框和线条颜色以增强可读性 (loonghfut)
- feat: 优化样式面板逻辑，避免在选择思维导图时加载默认样式控件 (loonghfut)
- feat: 引入 tldrawkey 以动态设置许可证密钥 (loonghfut)
- feat: 添加思维导图字体大小选择功能，支持动态调整节点样式 (loonghfut)
- feat: 添加布局方向支持，优化思维导图节点位置计算逻辑 (loonghfut)
- feat: 更新样式面板，添加导图方向按钮以便于快速调整排列方向 (loonghfut)
- feat: 调整节点渲染区域的悬浮检测区域以适应不同方向 (loonghfut)
- feat: 增加垂直布局时父子节点间的额外间距支持 (loonghfut)
- feat: 为颜色选择器组件添加关闭功能，支持失焦自动关闭 (loonghfut)
- feat: 动态调整折叠按钮尺寸以提高可点击性 (loonghfut)
- feat: 添加上下文菜单功能，支持节点操作和Markdown粘贴 (loonghfut)
- feat: 添加导出为列表格式功能到上下文菜单 (loonghfut)
- feat: 添加确认对话框组件并在上下文菜单中集成替换操作确认 (loonghfut)
- feat: 调整上下文菜单溢出处理，允许菜单超出容器边界以改善用户体验 (loonghfut)
