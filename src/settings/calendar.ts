    ...
    subGroups: [
        ...
        },
        {
            ...
            items: [
                ...
                { type: "custom", component: "TemplateEditor", title: "ICS导入模板", description: "可视化编辑导入模板，支持占位符插入和预览", key: "cal-ics-custom-template", value: ctx.settings["cal-ics-custom-template"], direction: "column", placeholders: ["title", "startTime", "endTime", "startDate", "endDate", "startDateTime", "endDateTime", "short_startTime", "short_endTime", "location", "description", "status", "recurrence", "tags"], placeholderDescriptions: { "title": "事件标题", "startTime": "开始时间 (本地格式)", "endTime": "结束时间 (本地格式)", "startDate": "开始日期 (YYYY-MM-DD)", "endDate": "结束日期 (YYYY-MM-DD)", "startDateTime": "开始日期时间 (YYYY-MM-DD HH:mm)", "endDateTime": "结束日期时间 (YYYY-MM-DD HH:mm)", "short_startTime": "开始时间 (短格式)", "short_endTime": "结束时间 (短格式)", "location": "地点", "description": "描述", "status": "状态", "recurrence": "重复规则", "tags": "标签" }, placeholderCategories: { "事件信息": ["title", "description", "location"], "时间字段": ["startTime", "endTime", "startDate", "endDate", "startDateTime", "endDateTime"], "短格式时间": ["short_startTime", "short_endTime"], "其他信息": ["status", "recurrence", "tags"] }, rows: 8 },
            ]
        },
        {
            name: "视图设置",
