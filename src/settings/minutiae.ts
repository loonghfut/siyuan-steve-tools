    ...
    subGroups: [
        ...
        },
        {
            ...
            items: [
                ...
                { type: "textarea", title: "笔记本黑名单", description: "一行一个笔记本ID或名称；列入的笔记本在切换时不会自动设置题头图。支持使用逗号、分号或换行分隔。", key: "minutiae-headimg-notebook-blacklist", value: ctx.settings["minutiae-headimg-notebook-blacklist"], direction: "row" },
            ]
        },
        {
            name: "随机背景图",
