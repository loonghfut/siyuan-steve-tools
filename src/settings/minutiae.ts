    ...
    subGroups: [
        ...
        },
        {
            ...
            items: [
                ...
                { type: "textarea", title: "文档ID题头图映射", description: "配置特定文档ID的题头图链接（JSON格式），格式示例：{\"20251009185242-fse4qx0\": \"https://example.com/image1.jpg\", \"20251005215652-b9l5167\": \"https://example.com/image2.jpg\"}。从文档路径的.sy往左识别ID，匹配到则使用对应链接", key: "minutiae-headimg-id-mapping", value: ctx.settings["minutiae-headimg-id-mapping"],direction: "row"},
            ]
        }
    ]
