...
export const minutiaeDefaults: Record<string, any> = {
    ...
    "minutiae-headimg-notebook-blacklist": "",
    ...
    subGroups: [
        ...
        },
        {
            ...
            items: [
                ...
                { type: "custom", component: "NotebookBlacklistEditor", title: "笔记本黑名单", description: "勾选需要排除自动题头图的笔记本。", key: "minutiae-headimg-notebook-blacklist", value: ctx.settings["minutiae-headimg-notebook-blacklist"], direction: "column" },
            ]
        },
        {
            name: "随机背景图",
