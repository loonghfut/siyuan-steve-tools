    ...
    subGroups: [
        ...
        },
        {
            ...
            items: [
                ...
                { type: "select", title: "背景切换模式", description: "选择背景切换策略：切换文档 / 每次启动 / 指定背景（固定）", key: "minutiae-bg-mode", value: ctx.settings["minutiae-bg-mode"], options: { switch: "切换文档时切换", startup: "每次启动时切换", fixed: "指定背景图，不切换" } },
