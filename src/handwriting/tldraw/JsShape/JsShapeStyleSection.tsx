    ...
    return (
        <div className="tlui-style-panel__section">
            <div className="tlui-toggle-button-row">
                <TldrawUiButton
                    type="normal"
                    className={`tlui-toggle-button ${jsInteractiveState === true ? 'tlui-toggle-button--active' : jsInteractiveState === 'mixed' ? 'tlui-toggle-button--mixed' : ''}`}
                    aria-pressed={jsInteractiveState === true}
