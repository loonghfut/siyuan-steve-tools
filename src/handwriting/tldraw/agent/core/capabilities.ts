export function getTldrawAgentCapabilities() {
    return {
        ...
        agentPrompt: [
            ...
            'For branch hierarchy connections, do not pre-move child shapes or run a separate layout first. Branch auto-positions its children; only choose root/from, child/to, optional side, and optional spacing/style. The root shape or branch center controls the main position.',
        ...
        customShapeGuide: [
            ...
            },
            {
                ...
                notes: [
                    'Do not hand-place branch geometry and do not update child x/y before connecting. Provide from/to refs and optional side/style/spacing; branch will move children into place automatically.',
        ...
        layoutRecipes: [
            ...
            'Connect hierarchy: tldraw_shape_command intent connectShapes with connectionKind "branch"; do not pre-layout, branch auto-arranges children from the root/branch center.',
