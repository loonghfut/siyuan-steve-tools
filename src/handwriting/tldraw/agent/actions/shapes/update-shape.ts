import { assertKnownArgs, booleanArgWithFallback, numberArg, resultModeArg, stringArg } from '../../core/args';
...
export function createUpdateShapeAction(): AgentActionDefinition {
    return {
        ...
        handler: async (args) => {
            ...
            try {
                assertKnownArgs(args, ['whiteboardId', 'id', 'rootId', 'shapeId', 'x', 'y', 'w', 'h', 'color', 'isCollapsed', 'select', 'zoom', 'resultMode'], 'tldraw_update_shape');
            } catch (error) {
