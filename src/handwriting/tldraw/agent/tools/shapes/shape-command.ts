...
/** Accepts only the command intents implemented by the manager operation layer. */
...
/**
 * Normalizes alternate frontend wrapper formats into direct named arguments.
 * Some Agent UIs force payloads into id/query; the tool layer unwraps them here.
 */
...
/** Detects whether an object is likely the actual tldraw_shape_command payload. */
...
/** Reads the explicit patch object after accepting JSON-string wrapper values. */
...
/** Converts string, array, or object target forms into the internal target shape. */
...
/** Builds a small patch from convenient top-level fields such as x/y/color/text. */
...
/** Parses JSON object/array strings while leaving ordinary strings untouched. */
